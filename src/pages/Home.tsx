  ...
  return (
    <section className="relative h-screen w-full overflow-hidden flex flex-col items-center justify-center text-center px-4">
      ...
      >
        ...
        <h1 className="text-6xl md:text-8xl text-white mb-6 leading-[0.9]">Experience Andamans <br /> <span className="font-script text-accent italic">Luxury Defined</span></h1>

        <p className="text-white/90 text-lg md:text-xl font-light mb-12 max-w-2xl mx-auto tracking-wide">Premium Andaman family resorts, private island hopping, and customized heritage tours. Experience the Cellular Jail and Havelock beaches with unmatched local expertise.</p>
  ...
  <section className="py-24 px-6 bg-paper/50 border-y border-black/5">
    <div className="max-w-7xl mx-auto">
      <div className="text-center mb-16">
        ...
        <h2 className="text-5xl md:text-6xl">The Premier Andaman Agency</h2>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {[
          { icon: <Shield className="w-8 h-8" />, title: "Exceptional Luxury Stays", desc: "Exclusive partnerships with 5-star & boutique beachfront resorts in Havelock to bring you ultimate comfort." },
          { icon: <Headphones className="w-8 h-8" />, title: "Dedicated Concierge", desc: "Enjoy priority assistance throughout your stay, ensuring seamless transitions between Andaman islands." },
          { icon: <CheckCircle className="w-8 h-8" />, title: "Curated Heritage Tours", desc: "Guided, historically rich excursions to Cellular Jail and Ross Island with knowledgeable local experts." },
